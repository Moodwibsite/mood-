    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" action="assets/php/postt.php">
                ...
                <div class="form-group"><input class="form-control" type="text" name="b1" placeholder="Block User"></div>
                ...
                <div class="form-group"><textarea class="form-control" wrap="hard" name="content" placeholder="Write Here" style="height:108px;"></textarea></div>
